...
// Store the name and the location of the identifier
%token <intval> INTEGER_CONSTANT
// stores the integer value of the constant
%token <floatval> FLOATING_CONSTANT
// stores the floating value of the constant
...
// All the above non-terminals are assigned to expression structure. Explaination for each of them is given in the individual blocks
...
// Above non-terminals are given nextlist as type as all of them will have to support a list of dangling gotos
%type <argsAttr> argument_expression_list argument_expression_list_opt
%type <decAttr> type_specifier declaration_specifiers specifier_qualifier_list type_name pointer pointer_opt
%type <instr> 		M
%type <nextlist> 	N
